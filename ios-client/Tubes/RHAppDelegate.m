...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // initialize the pusher manager
    RHPusherManager *pusherManager = [RHPusherManager sharedInstance];
    
    self.viewController = [[RHViewController alloc] init];

    UINavigationController *nvc = [[UINavigationController alloc] initWithRootViewController:self.viewController];
    
    [[UINavigationBar appearance] setTintColor:[UIColor colorWithRed:0.000 green:0.660 blue:0.093 alpha:1.000]];
